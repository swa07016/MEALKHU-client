      ...
      <Container className="mb-4">
        ...
        <Row className="mb-5" xs="1" sm="1" md="3" lg="3">
          <Col>
            ...
            >
              <img
                src="https://cdn.jsdelivr.net/gh/swa07016/mealkhu-cdn/menu_icon.png"
                alt="menu-icon"
                width="50"
              />
          ...
          <Col>
            ...
            >
              <img
                src="https://cdn.jsdelivr.net/gh/swa07016/mealkhu-cdn/price_icon.png"
                alt="price-icon"
                width="50"
              />
          ...
          <Col>
            ...
            >
              <img
                src="https://cdn.jsdelivr.net/gh/swa07016/mealkhu-cdn/map_icon.png"
                alt="map-icon"
                width="50"
              />
              ...
              <p className="text-muted">
                랜덤 추천 기능, 음식점 지도를
                <br />볼 수 있는 밀쿠맵을 사용해보세요!
              </p>
              <a href="/random" style={{ textDecoration: 'none' }}>
                바로가기
              </a>
            </div>
          </Col>
        ...
        <Row xs="1" sm="1" md="2" lg="2">
          <Col className="order-lg-1 px-5 m-auto">
            <div className="px-4 py-5">
              <img
                className="img-fluid"
                src="https://cdn.jsdelivr.net/gh/swa07016/mealkhu-cdn/contact.png"
                alt="contact-image"
              />
            </div>
          </Col>
